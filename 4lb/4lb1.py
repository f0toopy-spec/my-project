...
print("Объяснение: Разные объекты (Transport, Car, Bike) по-разному реагируют")
print("на один и тот же метод move(), но интерфейс вызова одинаковый.")
print("Это позволяет работать с разными типами объектов единообразно.")